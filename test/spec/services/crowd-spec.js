describe('crowd', function(){
  ...
  it('should return avaliable people', function(){
    expect(crowd.avaliablePeople.size()).toBe(7);
  });

  it('should return ignored people', function(){
    expect(crowd.ignoredPeople.size()).toBe(1);
  });
  ...
  it('should give someone not ingored yet', function(){
    var someone = crowd.getOneAvaliable();
    expect( crowd.isPersonIgnored(someone) ).toBeFalsy();
  });

  it('should reset and make everybody avaliable', function(){
    crowd.reset();
    expect(crowd.avaliablePeople.size()).toBe(8);
    expect(crowd.ignoredPeople.size()).toBe(0);
  });
